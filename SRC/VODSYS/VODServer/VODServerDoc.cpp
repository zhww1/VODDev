...
// VODServerDoc.cpp : CVODServerDoc 类的实现
//
...
// 缩略图的支持
void CVODServerDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CVODServerDoc::InitializeSearchContent()
{
...
void CVODServerDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
